	...
	tests := []struct {
	...
	}{
		{
			...
			req: &types.LLMRequest{
				...
				Body: &types.LLMRequestBody{
					Completions: &types.CompletionsRequest{Prompt: "test"},
				},
			},
			input: []types.Pod{},
			err:   true,
		},
		{
			...
			req: &types.LLMRequest{
				...
				Body: &types.LLMRequestBody{
					Completions: &types.CompletionsRequest{Prompt: "12345678901"},
				},
			},
		...
		},
		{
			...
			req: &types.LLMRequest{
				...
				TargetModel: "critical",
				Body: &types.LLMRequestBody{
					Completions: &types.CompletionsRequest{Prompt: "12345678906"},
				},
			},
		...
		},
		{
			...
			req: &types.LLMRequest{
				...
				TargetModel: "critical",
				Body: &types.LLMRequestBody{
					Completions: &types.CompletionsRequest{Prompt: "12345"},
				},
			},
